...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [        
            ...
            'value' => function($data){
                ...
                return PopoverX::widget([
                    ...
                    'toggleButton'=>['label'=>$data->fileName, 'class'=>'myBtn btn btn-default','id'=>'btn'.$data->id,'onClick'=>'return false;']
                ]);
            }
        ],
        [        
        ...
        [        
            ...
            'value' => function($data){
                ...
                ])."</td><td><label class='cbx-label' for='".$name."'>"."<div class='metaInfo' style='display:block;'><b>".$placeUser->name."</b></div>"."<div class='metaInfoData'><i>".$placeUser->address."</i></div></label></td><td style='text-align:center'>".$str."</td></tr>";
                }
                ...
                'options' => [
                    ...
                    'body' => ''
                ]).Html::button('Сохранить', ['class'=>'btn btn-sm btn-primary','id'=>'btn'.(string)$data->id,'style'=>'margin:10px', 'onclick'=>'changeUserFiles(this.id);']),
  ...
  'buttons' => [
    ...
    'new_action3' => function ($url, $model) {
        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', Url::toRoute(['files/view', 'href' => $model->href]), [
